...
const songLeaveOutAllTheRest = new Song(
    './resources/leave-out-all-the-rest/LeaveOutAllTheRest.mp3', 
...
// Register this song
allSongs.push(songLeaveOutAllTheRest);

// Load the song audio into memory
songLeaveOutAllTheRest.load();

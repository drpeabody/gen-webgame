...
const songWhenTheyComeForMe = new Song(
    './resources/when-they-come-for-me/05WhenTheyComeForMe.mp3', 
...
// Register this song
allSongs.push(songWhenTheyComeForMe);

// Load the song audio into memory
songWhenTheyComeForMe.load();
